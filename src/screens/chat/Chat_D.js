...
import Chatform from "./ChatForm_D";
        ...
        <View style={styles.chat}>
          ...
          <View style={styles.center}>
            <View>
              <Text
                numberOfLines={1}
                style={{ fontSize: 17, fontFamily: "sans-serif",color: "#ffff" }}
              >
                {UserId.username}
              </Text>
            </View>
            <View>
              <Text
                numberOfLines={2}
                style={{ fontSize: 13, fontFamily: "sans-serif",color: "#ffff" }}
              >
          ...
          <View style={styles.right}>
            <Text
              numberOfLines={2}
              style={{ fontSize: 11, fontFamily: "sans-serif",color: "#ffff" }}
            >
        ...
        <View style={styles.chat}>
          ...
          >
            <View>
              <Text
                numberOfLines={1}
                style={{ fontSize: 20, fontFamily: "sans-serif",color: "#ffff" }}
              >
               { UserId.username}
              </Text>
            </View>
...
export default class Chat extends React.Component {
  ...
  Push = () => {
    ...
    const addNewData = (props) => {
      ...
      console.log("newDataArr", newDataArray)
      this.setState({
              ...
              {this.state.clicked ? (
                <View style={styles.text}>
                  ...
                  <TouchableOpacity onPress={() => this.fetchMessageAdd()}>
                    <FontAwesome name="paper-plane" color="white" size={27} />
                  </TouchableOpacity>
                </View>
              ) : (
                <TouchableOpacity
                ...
                >
                  <Image
                source={require("../../../assets/img/newchat_D.png")}
